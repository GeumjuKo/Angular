...
class UpdateStageCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_0_1.UpdateStageRequest.filterSensitiveLog,
    ...
    serialize(input, context) {
        return Aws_restJson1_1.serializeAws_restJson1UpdateStageCommand(input, context);
    }
    deserialize(output, context) {
        return Aws_restJson1_1.deserializeAws_restJson1UpdateStageCommand(output, context);
    }
}
